...
module github.com/rianhughes/core_rian
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/rianhughes/cosmos-sdk_rian v0.44.5-terra.2
	...
	github.com/tendermint/tendermint => github.com/rianhughes/tendermint_rian v0.34.14-terra.2
